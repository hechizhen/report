        ...
        methods: {
            ...
            getFinanceOverviewData() {
                ...
                this.$http({
                    ...
                    //财务报表数据
                    let list = [
                        {name:'销售净额（万元）',val:_this.dataProcess(data.in_money, 'money','tenth').num},
                        {name:'销售成本（万元）',val:_this.dataProcess(data.cost_money, 'money','tenth').num},
                        ...
                        {name:'经营利润（万元）',val:_this.dataProcess(data.profit_money, 'money','tenth').num}
                    ]
                    _this.financeData = list
                    //应收欠款数据
                    _this.receivableData = {
                        receivableTxt: '出库应收（万元）',
                        receivableValUnit: '￥',
                        receivableVal: _this.dataProcess(data.debt_money, 'money','tenth').num,
                        receivableMonth: '收货金额（万元）',
